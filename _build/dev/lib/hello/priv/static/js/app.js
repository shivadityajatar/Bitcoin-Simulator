...
var _single_socket = require("./single_socket");

var _single_socket2 = _interopRequireDefault(_single_socket);
...
var socketsList = []; // NOTE: The contents of this file will only be executed if
...
var bitcoinsHash = document.querySelector('#bitcoins');
var transMsg = document.querySelector('#transactions_msg');
var channel = void 0;
...
document.getElementById('create_coins').onclick = function () {
  ...
  console.log("in coin");
  channel.push("create_coins", {}).receive("ok", function (resp) {
    console.log("after coins created", resp);
  });
};

channel.on("start_transactions", function (payload) {
  var messageItem = document.createElement("ul");
...
channel.on("create_coins", function (payload) {
  ...
  var messageItem2 = document.createElement("ul");
  ...
  document.getElementById('start_transactions').onclick = function () {
    var messageItem3 = document.createElement("ul");
  ...
  var messageItem1 = document.createElement("ul");
